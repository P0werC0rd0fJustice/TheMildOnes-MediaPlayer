...
public class MediaPlayerController
{
    ...
    protected void handlePlayButtonAction(ActionEvent event)
    {
        ...
        if (playButtonCount % 2 == 1) {
            playButton.setStyle("-fx-background-image: url('playbutton.png');-fx-background-size: 30px;-fx-background-repeat: no-repeat;-fx-background-position: center;-fx-background-color: #000");
            playButton.setTooltip(new Tooltip("Play"));
            mediaPlayer.pause();
        } else {
            playButton.setStyle("-fx-background-image: url('pausebutton.png');-fx-background-size: 30px;-fx-background-repeat: no-repeat;-fx-background-position: center;-fx-background-color: #000");
    ...
    protected void handleVolumeButtonAction(ActionEvent event)
    {
        flag++;
        if (flag % 2 == 1) {
            volumeButton.setStyle("-fx-background-image: url('volumemutebutton.png');-fx-background-size: 30px;-fx-background-repeat: no-repeat;-fx-background-position: center;-fx-background-color: #000");
            ...
            volumeButton.setStyle("-fx-background-image: url('volumemaxbutton.png');-fx-background-size: 30px;-fx-background-repeat: no-repeat;-fx-background-position: center;-fx-background-color: #000");
            volumeButton.setTooltip(new Tooltip("Volume"));
